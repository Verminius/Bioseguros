...
function activarPublico() {
  publicoBtn.addEventListener("click", function () {
    ...
    let graphics = {
      0: "https://i.postimg.cc/PfC1fzm7/graficas-a.gif",
      1: "https://i.postimg.cc/K4XGmynm/graficas-b.gif",
      2: "https://i.postimg.cc/4dS4Fcy7/graficas-c.gif",
      3: "https://i.postimg.cc/MHfZkGfs/graficas-d.gif",
    };
